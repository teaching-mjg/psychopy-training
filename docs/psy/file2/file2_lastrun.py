...
expName = 'file2'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\mgreen\\gits\\psychopy-training-1-of-2\\psy\\file2\\file2_lastrun.py',
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() < 1.0:
        ...
        if key_resp_2.status == STARTED and not waitOnFlip:
            theseKeys = key_resp_2.getKeys(keyList=['c','d'], waitRelease=False)
