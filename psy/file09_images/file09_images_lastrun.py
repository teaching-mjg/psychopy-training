...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\mgreen\\gits\\psychopy-training-1-of-2\\psy\\file09_images\\file09_images_lastrun.py',
...
shuffle(image_list)
trialn = -1 # so we can use it as an index that has to start at 0
# keep track of which components have finished
setup_exptComponents = []
for thisComponent in setup_exptComponents:
